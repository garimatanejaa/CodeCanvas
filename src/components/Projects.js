...
function Projects() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const dummyProjects = [
        { id: 1, title: 'Portfolio (this)', description: 'A visually appealing portfolio website showcasing your achievements and projects with an elegant design, allowing you to present your merits in an aesthetically pleasing manner.', link: '#', source: 'https://github.com/garimatanejaa/resumee', skills: ['React', 'Chakra UI', 'JavaScript'] },
